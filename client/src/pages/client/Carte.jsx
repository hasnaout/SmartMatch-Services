...
const VILLES_COORDS = {
  ...
  'errachidie':       [31.9314, -4.4248],
  'mohammadia':       [33.6861, -7.3833],
  'kénitra':          [34.2610, -6.5802],
  'kenitra':          [34.2610, -6.5802],
  'témara':           [33.9287, -6.9071],
  'temara':           [33.9287, -6.9071],
  'safi':             [32.2994, -9.2372],
  'khouribga':        [32.8811, -6.9063],
  'béni mellal':      [32.3373, -6.3498],
  'beni mellal':      [32.3373, -6.3498],
  'nador':            [35.1740, -2.9287],
  'settat':           [33.0014, -7.6197],
  'berrechid':        [33.2657, -7.5877],
  'taza':             [34.2100, -3.9970],
  'larache':          [35.1932, -6.1560],
  'khémisset':        [33.8242, -6.0658],
  ...
  'azrou':            [33.4345, -5.2224],
  'ouarzazate':       [30.9202, -6.9028],
  'tiznit':           [29.6974, -9.7317],
  'taroudant':        [30.4703, -8.8769],
  'al hoceima':       [35.2517, -3.9372],
  'alhoceima':        [35.2517, -3.9372],
  'chefchaouen':      [35.1688, -5.2636],
  'benslimane':       [33.6155, -7.1259],
  'médiouna':         [33.4519, -7.5156],
  'mediuna':          [33.4519, -7.5156],
  'tit mellil':       [33.5519, -7.4678],
  'had soualem':      [33.4361, -7.8542],
  'bouskoura':        [33.4503, -7.6472],
  'nouaceur':         [33.3672, -7.5811],
  'ain chock':        [33.5285, -7.6164],
  'hay hassani':      [33.5406, -7.6706],
  'sidi bernoussi':   [33.6050, -7.5039],
};
