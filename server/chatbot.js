...
const knowledgeBase = [
  ...
  // ── Inscription prestataire ────────────────
  {
    ...
    response:
      "🛠️ Créez un compte, complétez votre profil (compétences, tarifs, photos, disponibilités) et activez-le pour commencer à recevoir des missions.",
  },
  ...
  // ── Suppression de compte ──────────────────
  {
    ...
    response:
      "🗑️ Vous pouvez supprimer votre compte depuis les paramètres → « Supprimer le compte ». Contactez le support si vous avez besoin d'aide.",
  },
  ...
  // ── API / Intégrations ─────────────────────
  {
    ...
    response:
      "⚙️ Nous proposons ou prévoyons des intégrations selon le plan produit. Contactez-nous à contact@smartmatch.com pour vos besoins d'entreprise.",
  },
  // ── Horaires ───────────────────────────────
  {
